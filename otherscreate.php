	...
	<body>
		<div id="main">
			...
			<div class="content2">
				...
				<?php }?>
				<div class="hed">
					<button class="btn10" onclick="window.location.href='gratcreate.php';"><h5><strong>Previous</strong></h5></button>
					<h2>Others</h2>
					<button class="btn10" onclick="window.location.href='myselfcreate.php';"><h5><strong>Next</strong></h5></button>
				</div>
				</br>
				<button class="btncreate" onclick="window.location.href='others.php';">Add Post</button>
				</br></br>
				<div class="back">
					 <div class="row">
					<?php foreach($query as $q){ ?>
						<div class="col">
							<p class="card-title" onclick="window.location.href='othview.php?id=<?php echo $q['id']?>';"><strong><?php echo $q['otherstitle'];?></strong></p>
						</div>
					<?php }?>
					</div>
				</div>
