	...
	<body>
		<div id="main">
			...
			<div class="content2">
				...
				<?php }?>
				<div class="hed">
					<button class="btn10" onclick="window.location.href='repcreate.php';"><h5><strong>Previous</strong></h5></button>
					<h2>Amends Plans</h2>
					<button class="btn10" onclick="window.location.href='cilecreate.php';"><h5><strong>Next</strong></h5></button>
				</div>
				</br>
				<button class="btncreate" onclick="window.location.href='amends.php';">Add Post</button>
				</br></br>
				<div class="back">
					 <div class="row">
					<?php foreach($query as $q){ ?>
						<div class="col">
							<p class="card-title" onclick="window.location.href='amenview.php?id=<?php echo $q['id']?>';"><strong><?php echo $q['date'];?>: <?php echo $q['who'];?></strong></p>
						</div>
					<?php }?>
					</div>
				</div>
