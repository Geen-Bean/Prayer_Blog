...
<html>
	...
	<body>
		<div id="main">
			...
			<div class="content2">
				<div class="hed">
					<button class="btn10" onclick="window.location.href='reconciliations.php';"><h5><strong>Previous</strong></h5></button>
					<h2>How to Christian</h2>
					<button class="btn10" onclick="window.location.href='sermon.php';"><h5><strong>Next</strong></h5></button>
				</div>
				</br>
				<div class="back">
					<form method="POST" id="christian">
						<p> Date/Topic: &nbsp;&nbsp;
