...
<html>
	...
	<body>
		<div id="main">
			...
			<div class="content2">
				<div class="hed">
					<button class="btn10" onclick="window.location.href='others.php';"><h5><strong>Previous</strong></h5></button>
					<h2>For Myself</h2>
					<button class="btn10" onclick="window.location.href='gratitude.php';"><h5><strong>Next</strong></h5></button>
				</div>
				</br>
				<div class="back">
					<form method="POST" id="myself">
						<p> Date/Topic: &nbsp;&nbsp;
							<input type="text" name="mytitle" size="70" maxlength="150" required="required" />
						</p>
						<p>Prayer:</p>
							<textarea name="my" size="75" cols="75" rows="35" value="" required="required" ></textarea>
						</br></br>
						<button class="btnbtn" name="mypost" value="">Add Post</button>
						</br>
					</form>
				</div>
			</div>
