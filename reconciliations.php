...
<html>
	...
	<body>
		<div id="main">
			...
			<div class="content2">
				<div class="hed">
					<button class="btn10" onclick="window.location.href='gender.php';"><h5><strong>Previous</strong></h5></button>
					<h2>Reconciliation Commentary</h2>
					<button class="btn10" onclick="window.location.href='christian.php';"><h5><strong>Next</strong></h5></button>
				</div>
				</br>
				<div class="back">
					<form method="POST" id="reconciliations">
						<p> Date/Topic: &nbsp;&nbsp;
						...
						<p>Application:</p>
							<textarea name="appl" size="75" cols="75" rows="20" required="required" ></textarea>
						<p>Notes:</p>
							<textarea name="note" size="75" cols="75" rows="20" required="required" ></textarea>
						</br></br>
