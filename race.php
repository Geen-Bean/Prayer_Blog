...
<html>
	...
	<body>
		<div id="main">
			...
			<div class="content2">
				<div class="hed">
					<button class="btn10" onclick="window.location.href='group.php';"><h5><strong>Previous</strong></h5></button>
					<h2>Race Commentary</h2>
					<button class="btn10" onclick="window.location.href='gender.php';"><h5><strong>Next</strong></h5></button>
				</div>
				</br>
				<div class="back">
