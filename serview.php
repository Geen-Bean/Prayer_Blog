		...
		<div id="main">
			...
			<div class="content2">
					...
					<?php foreach($query as $q){?>
						<div>
							<h2><?php echo $q['sertitle'];?></h2>
						</div>
						<div class="back">
							<div class="beep">
								<p><strong> Link to Sermon:</strong></p>
								<p><?php echo $q['serlink'];?></p>
								<p><strong> Bible References:</strong></p>
								<p><?php echo $q['serref'];?></p>
								<p><strong> Notes:</strong></p>
								<p><?php echo $q['sermon'];?></p>
							</div>
						</div>	
						</br>
						<div class="edit">
							<button  class="btnbtnbtn" onclick="window.location.href='seredit.php?id=<?php echo $q['id'];?>';">Edit</button>
							<form method="POST">
