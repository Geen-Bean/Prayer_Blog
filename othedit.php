					...
					<?php foreach($query as $q){?>
						<form method="POST" id="others">
							<input type="text" hidden name="id" value="<?php echo $q["id"];?>"/>
								<p> Date/Topic: &nbsp;&nbsp;
									<input type="text" name="otherstitle" size="70" maxlength="150" required="required" <?php echo $q["grattitle"];?>/>
								</p>
								<p>Prayer:</p>
									<textarea name="oth" size="75" cols="75" rows="35" value="" required="required" ><?php echo $q["grat"];?></textarea>
								</br></br>
